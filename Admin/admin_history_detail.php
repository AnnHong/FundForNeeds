<div class="w3-row">
  <div class="w3-col m7" style="margin-left: 20%;">
    <div class="w3-container w3-card w3-white w3-round w3-margin w3-animate-left"><br>
        <p><?php echo $data[1]; ?> have donated RM <?php echo $data[5]; ?> to <?php echo $data[2]; ?></p>
      <details id="details">
        <summary>Show Details</summary>
          <table style="width:50%;">
            ...
            <tr>
              ...
              <td>:&emsp;<b><?php echo $data[7]; ?></b></td>
            </tr>
            <tr>
              <td>Amount</td>
              <td>:&emsp;<b>RM<?php echo $data[5]; ?></b></td>
            </tr>
            <tr>
              <td>Receiver Name</td>
              <td>:&emsp;<b><?php echo $data[2]; ?></b></td>
            </tr>
            <tr>
